...
return {
  ...
  keys = {
    ...
    end, desc = "gitsigns / neogit" },
    { prefix .. "s", function() require('gitsigns').stage_hunk() end, desc = "stage hunk" },
    { prefix .. "u", function() require('gitsigns').undo_stage_hunk() end, desc = "undo stage hunk" },
    { prefix .. "a", function() require('gitsigns').stage_buffer() end, desc = "stage [a]ll of buffer" },
    { prefix .. "p", function() require('gitsigns').preview_hunk() end, desc = "preview hunk" },
    { prefix .. "d", function() require('gitsigns').toggle_deleted() end, desc = "toggle [d]eleted" },
