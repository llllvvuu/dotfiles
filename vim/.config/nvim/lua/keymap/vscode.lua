...
map("i", "<M-w>", function()
  require("vscode-neovim").action("editor.action.inlineSuggest.acceptNextWord")
end, { desc = "[copilot] accept word" })
map("i", "<M-l>", function()
  require("vscode-neovim").action("editor.action.inlineSuggest.acceptNextLine")
end, { desc = "[copilot] accept line" })
map("i", "<M-a>", function()
  require("vscode-neovim").action("editor.action.inlineSuggest.commit")
end, { desc = "[copilot] accept all" })
map("i", "<M-]>", function()
  require("vscode-neovim").action("editor.action.inlineSuggest.showNext")
end, { desc = "[copilot] show next" })
map("i", "<M-[>", function()
  require("vscode-neovim").action("editor.action.inlineSuggest.showPrevious")
